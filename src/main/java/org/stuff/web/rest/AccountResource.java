package org.stuff.web.rest;

import org.stuff.domain.User;
import org.stuff.service.InvalidPasswordException;
import org.stuff.service.MailService;
import org.stuff.service.UserService;
import org.stuff.service.UsernameAlreadyUsedException;
import org.stuff.service.dto.PasswordChangeDTO;
import org.stuff.service.dto.UserDTO;
import org.stuff.web.rest.errors.EmailAlreadyUsedException;
import org.stuff.web.rest.errors.EmailNotFoundException;
import org.stuff.web.rest.errors.LoginAlreadyUsedException;
import org.stuff.web.rest.vm.KeyAndPasswordVM;
import org.stuff.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (org.stuff.service.EmailAlreadyUsedException e) {
